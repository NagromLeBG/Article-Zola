...
\subsection{Nombre de segments associés à chaque topic}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figure/nb_segment_nmf.png}
    \caption{Nombre de segments associés à chaque topic dominant}
    \label{fig:segments_topic_dominant}
\end{figure}

Cette figure présente la répartition des segments du corpus selon leur topic dominant. Elle permet d'observer que les topics ne sont pas représentés de manière parfaitement équilibrée : certains thèmes regroupent un nombre important de segments, tandis que d'autres apparaissent de façon plus marginale. Cette variation est attendue dans un corpus littéraire, car tous les motifs thématiques ne sont pas présents avec la même intensité dans l'ensemble des romans.

Les topics les plus représentés correspondent aux thèmes qui structurent fortement le corpus. Ils renvoient probablement à des motifs récurrents dans l'œuvre de Zola, comme les espaces domestiques, les relations sociales, le travail, la famille ou encore les formes de vie quotidienne. À l'inverse, les topics moins représentés peuvent correspondre à des thèmes plus spécialisés, associés à certains romans précis ou à des univers narratifs plus localisés.

Cette distribution montre donc que la NMF ne produit pas seulement une liste de thèmes, mais permet aussi d'évaluer leur poids relatif dans le corpus. Le nombre de segments associés à chaque topic donne une première indication de l'importance quantitative des thèmes extraits. Il faut toutefois interpréter ces résultats avec prudence : un topic très fréquent n'est pas nécessairement plus important sur le plan littéraire, mais il est plus présent lexicalement dans les segments analysés.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=18cm,keepaspectratio]{figure/dendrogramme_clusters.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figure/df_annote.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figure/nb_segment_famille_cluster.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figure/nb_segment_cluster.png}
